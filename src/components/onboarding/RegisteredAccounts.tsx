...
const RegisteredAccounts = ({ persona, onLaunch }: Props) => {
  ...
  return (
    <div>
      ...
      <div className="space-y-5 mb-8">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-7 pr-3 py-2.5 border border-input rounded-lg text-sm bg-card text-foreground focus:outline-none focus:ring-2 focus:ring-primary/30"
            />
          </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className={`px-4 py-2 rounded-[10px] text-sm font-medium transition-colors ${!ownsHome ? 'bg-primary text-primary-foreground' : 'border-[1.5px] border-foreground text-foreground'}`}
            >
              No
            </button>
            <button
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2.5 border border-input rounded-lg text-sm bg-card text-foreground focus:outline-none focus:ring-2 focus:ring-primary/30"
          >
            {provinces.map((p) => (
      ...
      {/* Info box — warm yellow, not blue */}
      <div className="rounded-lg p-4 mb-8 border-l-[3px] border-l-warning" style={{ backgroundColor: '#FFF9ED' }}>
      ...
      <button
        onClick={onLaunch}
        className="w-full py-3 bg-primary text-primary-foreground rounded-[10px] font-semibold hover:opacity-90 transition-opacity text-lg"
      >
        Launch Co-Pilot →
      </button>
    </div>
